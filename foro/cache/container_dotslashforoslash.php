...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    {
        return $this->services['auth.provider.apache'] = new \phpbb\auth\provider\apache($this->get('dbal.conn'), $this->get('config'), $this->get('passwords.manager'), $this->get('request'), $this->get('user'), './foro/', 'php');
    }
    ...
    {
        return $this->services['auth.provider.db'] = new \phpbb\auth\provider\db($this->get('dbal.conn'), $this->get('config'), $this->get('passwords.manager'), $this->get('request'), $this->get('user'), $this, './foro/', 'php');
    }
    ...
    {
        return $this->services['auth.provider.oauth'] = new \phpbb\auth\provider\oauth\oauth($this->get('dbal.conn'), $this->get('config'), $this->get('passwords.manager'), $this->get('request'), $this->get('user'), 'bg_oauth_tokens', 'bg_oauth_accounts', $this->get('auth.provider.oauth.service_collection'), 'bg_users', $this, './foro/', 'php');
    }
    ...
    {
        $this->services['avatar.driver.gravatar'] = $instance = new \phpbb\avatar\driver\gravatar($this->get('config'), './foro/', 'php', $this->get('path_helper'), $this->get('cache.driver'));
    ...
    {
        $this->services['avatar.driver.local'] = $instance = new \phpbb\avatar\driver\local($this->get('config'), './foro/', 'php', $this->get('path_helper'), $this->get('cache.driver'));
    ...
    {
        $this->services['avatar.driver.remote'] = $instance = new \phpbb\avatar\driver\remote($this->get('config'), './foro/', 'php', $this->get('path_helper'), $this->get('cache.driver'));
    ...
    {
        $this->services['avatar.driver.upload'] = $instance = new \phpbb\avatar\driver\upload($this->get('config'), './foro/', 'php', $this->get('path_helper'), $this->get('mimetype.guesser'), $this->get('cache.driver'));
    ...
    {
        return $this->services['cache'] = new \phpbb\cache\service($this->get('cache.driver'), $this->get('config'), $this->get('dbal.conn'), './foro/', 'php');
    }
    ...
    {
        $this->services['class_loader'] = $instance = new \phpbb\class_loader('phpbb\\', './foro/includes/', 'php');
    ...
    {
        $this->services['class_loader.ext'] = $instance = new \phpbb\class_loader('\\', './foro/ext/', 'php');
    ...
    {
        return $this->services['config'] = new \phpbb\config\db($this->get('dbal.conn'), $this->get('cache.driver'), 'bg_config');
    }
    ...
    {
        return $this->services['config_text'] = new \phpbb\config\db_text($this->get('dbal.conn'), 'bg_config_text');
    }
    ...
    {
        return $this->services['console.command.db.migrate'] = new \phpbb\console\command\db\migrate($this->get('user'), $this->get('migrator'), $this->get('ext.manager'), $this->get('config'), $this->get('cache'), $this->get('log'), './foro/');
    }
    ...
    {
        return $this->services['content.visibility'] = new \phpbb\content_visibility($this->get('auth'), $this->get('config'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('user'), './foro/', 'php', 'bg_forums', 'bg_posts', 'bg_topics', 'bg_users');
    }
    ...
    {
        return $this->services['controller.helper'] = new \phpbb\controller\helper($this->get('template'), $this->get('user'), $this->get('config'), $this->get('controller.provider'), $this->get('ext.manager'), $this->get('symfony_request'), $this->get('request'), $this->get('filesystem'), './foro/', 'php');
    }
    ...
    {
        return $this->services['controller.resolver'] = new \phpbb\controller\resolver($this->get('user'), $this, './foro/', $this->get('template'));
    }
    ...
    {
        $instance = new \phpbb\captcha\plugins\qa('bg_captcha_questions', 'bg_captcha_answers', 'bg_qa_confirm');
    ...
    {
        return $this->services['cron.manager'] = new \phpbb\cron\manager($this->get('cron.task_collection'), './foro/', 'php');
    }
    ...
    {
        $this->services['cron.task.core.prune_all_forums'] = $instance = new \phpbb\cron\task\core\prune_all_forums('./foro/', 'php', $this->get('config'), $this->get('dbal.conn'));
    ...
    {
        $this->services['cron.task.core.prune_forum'] = $instance = new \phpbb\cron\task\core\prune_forum('./foro/', 'php', $this->get('config'), $this->get('dbal.conn'));
    ...
    {
        $this->services['cron.task.core.prune_shadow_topics'] = $instance = new \phpbb\cron\task\core\prune_shadow_topics('./foro/', 'php', $this->get('config'), $this->get('dbal.conn'), $this->get('log'), $this->get('user'));
    ...
    {
        $this->services['cron.task.core.queue'] = $instance = new \phpbb\cron\task\core\queue('./foro/', 'php', $this->get('config'));
    ...
    {
        $this->services['cron.task.core.tidy_database'] = $instance = new \phpbb\cron\task\core\tidy_database('./foro/', 'php', $this->get('config'));
    ...
    {
        $this->services['cron.task.core.tidy_plupload'] = $instance = new \phpbb\cron\task\core\tidy_plupload('./foro/', $this->get('config'));
    ...
    {
        $this->services['cron.task.core.tidy_search'] = $instance = new \phpbb\cron\task\core\tidy_search('./foro/', 'php', $this->get('auth'), $this->get('config'), $this->get('dbal.conn'), $this->get('user'));
    ...
    {
        $this->services['cron.task.core.tidy_warnings'] = $instance = new \phpbb\cron\task\core\tidy_warnings('./foro/', 'php', $this->get('config'));
    ...
    protected function getDbal_Conn_DriverService()
    {
        ...
        $instance->sql_connect('localhost', 'root', '', 'pawno_forobg', '', false, false);
    ...
    {
        return $this->services['ext.manager'] = new \phpbb\extension\manager($this, $this->get('dbal.conn'), $this->get('config'), $this->get('filesystem'), $this->get('user'), 'bg_ext', './foro/', 'php', $this->get('cache.driver'));
    }
    ...
    {
        return $this->services['feed.helper'] = new \phpbb\feed\helper($this->get('config'), $this->get('user'), './foro/', 'php');
    }
    ...
    {
        return $this->services['hook_finder'] = new \phpbb\hook\finder('./foro/', 'php', $this->get('cache.driver'));
    }
    ...
    {
        return $this->services['kernel_request_subscriber'] = new \phpbb\event\kernel_request_subscriber($this->get('ext.manager'), './foro/', 'php');
    }
    ...
    {
        return $this->services['log'] = new \phpbb\log\log($this->get('dbal.conn'), $this->get('user'), $this->get('auth'), $this->get('dispatcher'), './foro/', 'adm/', 'php', 'bg_log');
    }
    ...
    {
        return $this->services['message.form.admin'] = new \phpbb\message\admin_form($this->get('auth'), $this->get('config'), $this->get('config_text'), $this->get('dbal.conn'), $this->get('user'), './foro/', 'php');
    }
    ...
    {
        return $this->services['message.form.topic'] = new \phpbb\message\topic_form($this->get('auth'), $this->get('config'), $this->get('dbal.conn'), $this->get('user'), './foro/', 'php');
    }
    ...
    {
        return $this->services['message.form.user'] = new \phpbb\message\user_form($this->get('auth'), $this->get('config'), $this->get('dbal.conn'), $this->get('user'), './foro/', 'php');
    }
    ...
    {
        return $this->services['migrator'] = new \phpbb\db\migrator($this, $this->get('config'), $this->get('dbal.conn'), $this->get('dbal.tools'), 'bg_migrations', './foro/', 'php', 'bg_', $this->get('migrator.tool_collection'), $this->get('migrator.helper'));
    }
    ...
    {
        return $this->services['migrator.tool.module'] = new \phpbb\db\migration\tool\module($this->get('dbal.conn'), $this->get('cache'), $this->get('user'), './foro/', 'php', 'bg_modules');
    }
    ...
    {
        return $this->services['migrator.tool.permission'] = new \phpbb\db\migration\tool\permission($this->get('dbal.conn'), $this->get('cache'), $this->get('auth'), './foro/', 'php');
    }
    ...
    {
        return new \phpbb\notification\method\email($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './foro/', 'php');
    }
    ...
    {
        return new \phpbb\notification\method\jabber($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './foro/', 'php');
    }
    ...
    {
        return new \phpbb\notification\type\admin_activate_user($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './foro/', 'php', 'bg_notification_types', 'bg_notifications', 'bg_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\approve_post($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './foro/', 'php', 'bg_notification_types', 'bg_notifications', 'bg_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\approve_topic($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './foro/', 'php', 'bg_notification_types', 'bg_notifications', 'bg_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\bookmark($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './foro/', 'php', 'bg_notification_types', 'bg_notifications', 'bg_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\disapprove_post($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './foro/', 'php', 'bg_notification_types', 'bg_notifications', 'bg_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\disapprove_topic($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './foro/', 'php', 'bg_notification_types', 'bg_notifications', 'bg_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\group_request($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './foro/', 'php', 'bg_notification_types', 'bg_notifications', 'bg_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\group_request_approved($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './foro/', 'php', 'bg_notification_types', 'bg_notifications', 'bg_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\pm($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './foro/', 'php', 'bg_notification_types', 'bg_notifications', 'bg_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\post($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './foro/', 'php', 'bg_notification_types', 'bg_notifications', 'bg_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\post_in_queue($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './foro/', 'php', 'bg_notification_types', 'bg_notifications', 'bg_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\quote($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './foro/', 'php', 'bg_notification_types', 'bg_notifications', 'bg_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\report_pm($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './foro/', 'php', 'bg_notification_types', 'bg_notifications', 'bg_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\report_pm_closed($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './foro/', 'php', 'bg_notification_types', 'bg_notifications', 'bg_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\report_post($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './foro/', 'php', 'bg_notification_types', 'bg_notifications', 'bg_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\report_post_closed($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './foro/', 'php', 'bg_notification_types', 'bg_notifications', 'bg_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\topic($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './foro/', 'php', 'bg_notification_types', 'bg_notifications', 'bg_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\topic_in_queue($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './foro/', 'php', 'bg_notification_types', 'bg_notifications', 'bg_user_notifications');
    }
    ...
    {
        return $this->services['notification_manager'] = new \phpbb\notification\manager($this->get('notification.type_collection'), $this->get('notification.method_collection'), $this, $this->get('user_loader'), $this->get('config'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('cache'), $this->get('user'), './foro/', 'php', 'bg_notification_types', 'bg_notifications', 'bg_user_notifications');
    }
    ...
    {
        return $this->services['passwords.driver.md5_phpbb2'] = new \phpbb\passwords\driver\md5_phpbb2($this->get('request'), $this->get('passwords.driver.salted_md5'), $this->get('passwords.driver_helper'), './foro/', 'php');
    }
    ...
    {
        return $this->services['path_helper'] = new \phpbb\path_helper($this->get('symfony_request'), $this->get('filesystem'), $this->get('request'), './foro/', 'php', 'adm/');
    }
    ...
    {
        return $this->services['plupload'] = new \phpbb\plupload\plupload('./foro/', $this->get('config'), $this->get('request'), $this->get('user'), $this->get('php_ini'), $this->get('mimetype.guesser'));
    }
    ...
    {
        return $this->services['profilefields.lang_helper'] = new \phpbb\profilefields\lang_helper($this->get('dbal.conn'), 'bg_profile_fields_lang');
    }
    ...
    {
        return $this->services['profilefields.manager'] = new \phpbb\profilefields\manager($this->get('auth'), $this->get('dbal.conn'), $this->get('dispatcher'), $this->get('request'), $this->get('template'), $this->get('profilefields.type_collection'), $this->get('user'), 'bg_profile_fields', 'bg_profile_lang', 'bg_profile_fields_data');
    }
    ...
    {
        return $this->services['user_loader'] = new \phpbb\user_loader($this->get('dbal.conn'), './foro/', 'php', 'bg_users');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            'core.root_path' => './foro/',
            'core.php_ext' => 'php',
            'tables.auth_provider_oauth_token_storage' => 'bg_oauth_tokens',
            'tables.auth_provider_oauth_account_assoc' => 'bg_oauth_accounts',
            'tables.captcha_qa_questions' => 'bg_captcha_questions',
            'tables.captcha_qa_answers' => 'bg_captcha_answers',
            'tables.captcha_qa_confirm' => 'bg_qa_confirm',
            'tables.config' => 'bg_config',
            'tables.config_text' => 'bg_config_text',
            'tables.ext' => 'bg_ext',
            'tables.forums' => 'bg_forums',
            'tables.log' => 'bg_log',
            'tables.migrations' => 'bg_migrations',
            'tables.modules' => 'bg_modules',
            'tables.notification_types' => 'bg_notification_types',
            'tables.notifications' => 'bg_notifications',
            'tables.profile_fields' => 'bg_profile_fields',
            'tables.profile_fields_data' => 'bg_profile_fields_data',
            'tables.profile_fields_options_language' => 'bg_profile_fields_lang',
            'tables.profile_fields_language' => 'bg_profile_lang',
            'tables.posts' => 'bg_posts',
            'tables.topics' => 'bg_topics',
            'tables.user_notifications' => 'bg_user_notifications',
            'tables.users' => 'bg_users',
